...
**yourFinance v2** is a full-stack personal finance management tool that helps you track your expenses, visualize spending habits, and set financial goals. This release introduces a front-end interface on top of the completed backend system.

---

## ⚙️ Backend Features (Fully Functional)
...
- 📊 **Analytics**
  - Analyze Expenses by Type/Category
  - Basic Visualization Support

- 🧮 **Budgeting**
  - Set Monthly Budget *(Tracking not yet implemented)*

---

## 🌐 Frontend Progress

- ✅ Most pages are functional
